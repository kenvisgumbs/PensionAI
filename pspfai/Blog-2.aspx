<%@ Page Title="" Language="C#" MasterPageFile="~/PSPFAI.Master" AutoEventWireup="true" CodeBehind="Blog-2.aspx.cs" Inherits="pspfai.Blog_2" %>
                            ...
                            <div class="item-holder">
                                ...
                                <div class="text-area">
                                    <div class="content-text text-left">
                                        <div class="title">
                                            <a href="blog-single.aspx">
                                                <h5>Stand Up for Democracy in japan</h5>
                                            </a>
                                        </div>
                                        <div class="text">
                                            <p>Nisl dolor accllentesque faucibus. numaris vel, tincidunt fusce tempor non, laoreet volat integer quam iaculis est malesuada </p>
                            ...
                            <div class="item-holder">
                                ...
                                <div class="text-area">
                                    <div class="content-text text-left">
                                        <div class="title">
                                            <a href="blog-single.aspx">
                                                <h5>The Look of the French Election</h5>
                                            </a>
                                        </div>
                                        <div class="text">
                                            <p>Nisl dolor accllentesque faucibus. numaris vel, tincidunt fusce tempor non, laoreet volat integer quam iaculis est malesuada </p>
